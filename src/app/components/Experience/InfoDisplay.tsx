...
const InfoDisplay: React.FC<InfoDisplayProps> = ({ item }) => {
    ...
    return (
        <div className="w-full">
            ...
            <div className="mb-1">{item.info}</div>
                    ...
                    >
                        <ul className="pl-4 mb-2 marker:text-sky-400">
                            {item.bullets.map((bullet, key) => (
                                <li key={key} className="list-disc">{bullet}</li>
                            ))}
                        </ul>
                        ...
                        <button
                            ...
                            className="w-full text-sm flex flex-row justify-center items-center underline pt-6 text-custom-text-dark-gray hover:text-custom-text-gray"
                        >
            ...
            {!seeMore && (
                <button
                    ...
                    className="w-full flex text-sm flex-row justify-center items-center underline pt-6 text-custom-text-dark-gray hover:text-custom-text-gray"
                >
