  ...
  const work = [
    {
      ...
      info: "Google SWE intern in the Youtube Ads team.",
      bullets: [
        "Addede new stage to the video discovery pipeline to obtain a time-stamped transcript and find brand mentions in a youtube video.",
        "Developed a new component to display brand mentions in the Ads platform and designed backend changes.",
        "Formulated and evaluated a prompt to find brand mentions, improving precision from 74 to 95%",
        "Worked with python for prompt analisis, c++ for the pipeline, sql for post-processing gemini output, angular dart for the frontend and java for the backend.",
      ],
      images: [],
  ...
  const leadership = [
    {
      ...
      images: ["/images/photos/Rbrgs1.png", "/images/photos/Rbrgs2.png"],
    ...
    },
    {
      ...
      images: ["/images/photos/Vitales.png"],
